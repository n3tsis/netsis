...
This mechanism has been integrated into Bitcore-Node-Netsis which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/netsispay/insight-api-netsis#web-socket-api](https://github.com/netsispay/insight-api-netsis#web-socket-api)
* API: [https://github.com/netsispay/insight-api-netsis#instantsend-transactions](https://github.com/netsispay/insight-api-netsis#instantsend-transactions)
