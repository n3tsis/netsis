...
This document provides guidelines for internationalization of the Netsis Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `netsis_en.ts` remains unchanged.
