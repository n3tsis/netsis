...
* netsis.conf: contains configuration settings for netsisd or netsis-qt
* netsisd.pid: stores the process id of netsisd while running
...
* debug.log: contains debug information and general logging generated by netsisd or netsis-qt
