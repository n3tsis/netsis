Contributing to Netsis Core
============================

The Netsis Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/netsispay/netsis/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Netsis Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Netsis
Network Protocol consensus changes.

Whether a pull request is merged into Netsis Core rests with the project merge
...
Patches that change Netsis consensus rules are considerably more involved than
...
Where a patch set proposes to change the Netsis consensus, it must have been
...
The review process is normally fairly responsive on the Netsis Core repository, however
...
The project leader is the release manager for each Netsis Core release.
