...
Arguments:
    <base_directory> - The base directory of a Netsis Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Netsis Core developers'
...
Arguments:
    <base_directory> - The base directory of Netsis Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Netsis Core repository.
"""
