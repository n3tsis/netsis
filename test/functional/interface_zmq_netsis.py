...
"""Test the netsis specific ZMQ notification interfaces."""
...
from test_framework.test_framework import (
     NetsisTestFramework, skip_if_no_bitcoind_zmq, skip_if_no_py3_zmq)
...
class NetsisZMQTest (NetsisTestFramework):
    def set_test_params(self):
        ...
        self.set_netsis_test_params(4, 3, fast_dip3_enforcement=True, extra_args=[node0_extra_args, [], [], []])

    def run_test(self):
        # Check that netsisd has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all netsis related ZMQ publisher
