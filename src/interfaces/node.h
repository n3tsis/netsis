...
//! Interface for the src/evo part of a netsis node (netsisd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a netsis node (netsisd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a netsis node (netsisd process).
...
//! Top-level interface for a netsis node (netsisd process).
class Node
{
public:
    virtual ~Node() {}
