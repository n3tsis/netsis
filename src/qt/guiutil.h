...
/** Utility functions used by the Netsis Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "netsis:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load netsis specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a netsis specific theme is activated (light/dark).*/
