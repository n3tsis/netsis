...
//
//     src/qt/test/test_netsis-qt -platform xcb      # Linux
//     src/qt/test/test_netsis-qt -platform windows  # Windows
//     src/qt/test/test_netsis-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(2).indexOf(QString("URI: netsis:")) != -1);
