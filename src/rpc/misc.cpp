...
UniValue debug(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            " - \"netsis\" activates all Netsis-specific categories at once;\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("debug", "netsis")
            + HelpExampleRpc("debug", "netsis+net")
        );
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nReturn information about the given netsis address.\n"
            ...
            "\nArguments:\n"
            "1. \"address\"                    (string, required) The netsis address to validate\n"
            "\nResult:\n"
            "{\n"
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The netsis address to use for the signature.\n"
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"balance\": xxxxx,              (numeric) The current total balance in Satoshi\n"
            "  \"balance_immature\": xxxxx,     (numeric) The current immature balance in Satoshi\n"
            "  \"balance_spendable\": xxxxx,    (numeric) The current spendable balance in Satoshi\n"
            "  \"received\": xxxxx              (numeric) The total number of Satoshi received (including change)\n"
            "}\n"
            "\nExamples:\n"
...
UniValue echo(const JSONRPCRequest& request)
{
    if (request.fHelp)
        throw std::runtime_error(
            ...
            "netsis-cli and the GUI. There is no server-side difference."
        );
...
static UniValue getinfo_deprecated(const JSONRPCRequest& request)
{
    throw JSONRPCError(RPC_METHOD_NOT_FOUND,
        ...
        "\nnetsis-cli has the option -getinfo to collect and format these in the old format."
    );
}
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Netsis features */
    { "netsis",               "mnsync",                 &mnsync,                 {} },
    { "netsis",               "spork",                  &spork,                  {"arg0","value"} },
