 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1699606284, nBits=1e0ffff0, nNonce=750981, vtx=1)
...
{
    const char* pszTimestamp = "NetsisCoin for your Security 01 01 2024";
    const CScript genesisOutputScript = CScript() << ParseHex("04e0df8bbe3df985b57e8b6be1e7a08e7c913f24b5513a6c5dc0fcdb1064d3bbea0002c218b345b5323e8a4fe4ab42218b89fe78f4e38708f21332736f065a24b3") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1699606284, 750981, 0x1e0ffff0, 1, 500 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000009e7abe4f170b20831c0965cfa8a1c3f1b5f77328c11416b6f339a430d56"));
        assert(genesis.hashMerkleRoot == uint256S("0x582195e9b978dd643e11c986b6668e46670d94a62a67c2983ff9ad7043d088fa"));
        ...
        vSeeds.emplace_back("node1.netsiscoin.com");
        vSeeds.emplace_back("node2.netsiscoin.com");
        ...
        // Netsis BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Netsis BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // Netsis BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"NiRfGHQioeQEJcuyRtYamVmvgFKuaU1yUJ"};
        nMinSporkKeys = 1;
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000b5977f085491ffe63b2d3782ed487aec1a8acf357f74d9b19efe6c326a7"); 
        ...
        genesis = CreateGenesisBlock(1699606289UL, 33522UL, 0x1e0ffff0, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000b5977f085491ffe63b2d3782ed487aec1a8acf357f74d9b19efe6c326a7"));
        assert(genesis.hashMerkleRoot == uint256S("0x582195e9b978dd643e11c986b6668e46670d94a62a67c2983ff9ad7043d088fa"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,181);
        // Testnet Netsis BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Netsis BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Netsis BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"NR7dFKFDkGhgmfXfGTf6TgbPTXZKX3TkaL"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = {
            {
                {0, uint256S("0x00000b5977f085491ffe63b2d3782ed487aec1a8acf357f74d9b19efe6c326a7")},
            }
        };

        chainTxData = ChainTxData{
            1699606289, // * UNIX timestamp of last known number of transactions
...
public:
    CDevNetParams(bool fHelpOnly = false) {
        ...
        genesis = CreateGenesisBlock(1699606294, 3, 0x207fffff, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x20c539469ac4756217ea8f6173794363895ea15f4f8d0e379618e95d9b7dcb74"));
        assert(genesis.hashMerkleRoot == uint256S("0x582195e9b978dd643e11c986b6668e46670d94a62a67c2983ff9ad7043d088fa"));

        if (!fHelpOnly) {
            devnetGenesis = FindDevNetGenesisBlock(genesis, 500 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x20c539469ac4756217ea8f6173794363895ea15f4f8d0e379618e95d9b7dcb74")},
...
public:
    CRegTestParams() {
        ...
        // privKey: 75mSVjiR4bTFHB6SJayhfNVUqxZ68V5r4XLjsmDM5c593Wa19Pv
        vSporkAddresses = {"NQZM5DChximosJvf4QUm56E1RSfnpo1tE4"};
        nMinSporkKeys = 1;
        ...
        // Regtest Netsis addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,53);
        // Regtest Netsis script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,54);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,181);
        // Regtest Netsis BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Netsis BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Netsis BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
