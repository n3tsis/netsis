...
// See https://github.com/netsispay/dips/blob/master/dip-0006.md for more details
struct LLMQParams {
    LLMQType type;
...
struct Params {
    ...
    int nSuperblockStartBlockV2;
    uint256 nSuperblockStartHashV2;
    int nSuperblockCycleV2; // in blocks
